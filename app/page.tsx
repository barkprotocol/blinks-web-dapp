...
import { Zap, Send, BarChart2, ArrowRight, ExternalLink, Mail, Sparkles, Menu, Wallet } from 'lucide-react'
...
const ConnectWalletButton: React.FC = () => (
  <Button className="bg-[#D0BFB4] text-gray-900 hover:bg-[#C0AFA4] transition-colors flex items-center space-x-2 px-4 py-2 rounded-full">
    ...
    <div className="min-h-screen font-sans bg-gray-50 text-gray-900">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <section id="newsletter" className="mb-20 py-12 sm:py-16 bg-[#D0BFB4] rounded-lg">
          <div className="max-w-4xl mx-auto px-4">
            ...
            <form onSubmit={handleSubscribe} className="flex flex-col sm:flex-row gap-4 max-w-xl mx-auto">
              ...
              />
              <Button type="submit" className="bg-gray-900 text-white hover:bg-gray-800 transition-colors rounded-full">
                Subscribe
        ...
        <section id="cta" className="mb-20 text-center">
          ...
          <Button className="bg-[#D0BFB4] text-gray-900 hover:bg-[#C0AFA4] transition-colors text-lg px-8 py-4 rounded-full">
            Launch App
            <ArrowRight className="ml-2 h-5 w-5" />
          </Button>
        </section>
